const densities = {
        ...
        "lime juice": 240, "soy sauce": 254, "red wine vinegar": 240, "corn syrup": 368, "black pepper": 2.5
    };
    ...
    const recipes = [
        ...
        {
            id: "dominos style pizza", type: "pizza", category: "Pizza", name: "Dominos Style Hand-Tossed", desc: "Soft dough, buttery garlic crust.", baseArea: 452,
            ingredients: [
        ...
        {
            id: "tavern style pizza", type: "pizza", category: "Pizza", name: "Chicago Tavern Style", desc: "Thin, crispy 24-hr cold ferment.", baseArea: 226,
            ingredients: [
        ...
        {
            id: "Spring roll bowls", type: "standard", category: "Chicken", name: "Spring Roll Bowls", desc: "Deconstructed spring rolls in a bowl", ingredients:[
        ...
        },
        {
            id: "Chicken fajitas", type: "standard", category: "Chicken", name: "Chicken Fajitas", desc: "Classic chicken fajitas", ingredients:[
                {name: "Chicken", val: 100, isChicken: true}, {name: "Bell pepper", val: 2, isQty: true},{name: "Onion", val: 1, isQty: true},
